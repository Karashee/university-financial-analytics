...
def get_variance_report(
    ...
    dept_filter = get_dept_filter(current_user)
    return analytics_service.compute_variance_report(db, dept_id_filter=dept_filter)
...
def get_growth_rate(
    ...
    dept_filter = get_dept_filter(current_user)
    return analytics_service.compute_growth_rate_summary(db, dept_id_filter=dept_filter)
